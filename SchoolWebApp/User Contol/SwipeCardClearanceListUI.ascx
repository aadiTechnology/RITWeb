<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="SchoolWebApp.SwipeCardClearanceListUI" Codebehind="SwipeCardClearanceListUI.ascx.cs" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <asp:CustomValidator ID="cstForm" Display="None" runat="server" CssClass="ClsMdtStar"
                        Visible="true" ValidationGroup="Show"></asp:CustomValidator>
                                ...
                                <table width="97%" align="center">
                                    <tr>
                                        ...
                                        <td valign="top" class="ClsBorderlight">
                                            <asp:DropDownList ID="cmbCardType" runat="server" AutoPostBack="false" TabIndex="10">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td align="right" valign="top">
                                            <asp:GridView ID="grdvwCardPayments" runat="server" Width="100%" AutoGenerateColumns="False"
                                                ...
                                                EmptyDataText="No Record Found" DataKeyNames="StudentCardPaymentDetailsId" OnRowDataBound="grdvwCardPayments_RowDataBound"
                                                TabIndex="12" >
    ...
    <tr>
        ...
        <td>
            <asp:Button ID="btnBack" Text="Back" CssClass="ClsBtn" runat="server" CausesValidation="false"
                PostBackUrl="~/RITeSchool/Common/ControlPanel.aspx" TabIndex="14" />
