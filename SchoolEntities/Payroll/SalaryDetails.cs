...
namespace PayrollEntities
{
    ...
    public class UsersEarningsDeduction : SchoolEntity
    {
        ...
        public bool IsActivePayScale { get; set; }
    ...
    public class SalaryEntityList
    {
        ...
        public List<UserSpecialCaseDetails> lstUserSpecialCaseDetails = new List<UserSpecialCaseDetails>();
    }
    ...
    public class StaffInOutDetails
    {
        public string EmployeeNo { get; set; }
        public string UserName { get; set; }
        public DateTime OutDateTime { get; set; }
        public DateTime InDateTime { get; set; }
        public Int64 IndexNo { get; set; } 
    }

    public class EmployeeNoDetails
    {
        public string EmployeeNo { get; set; }
        public int SrNo { get; set; }
    }
    ...
    public class SalaryChange
    {
        ...
        public int DAPercentage { get; set; }
        public int HRAPercentage { get; set; }
        public string MonthName { get; set; }
        public int Amount { get; set; }
    }

    public class PaidSalaryDifference
    {
        public int Year { get; set; }
        public int MonthId { get; set; }
        public int EdId { get; set; }
        public string ShortName { get; set; }
        public int OriginalEdId { get; set; }        
        public string MonthName { get; set; }
        public int Amount { get; set; }
    ...
    public class UserSpecialCaseDetails
    {
