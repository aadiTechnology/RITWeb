...
public partial class SwipeCardClearanceListUI : PaymentClearanceUC
{
    ...
    public override void FillPaymnetsGrid()
    {
        ...
        DataTable oDt = oCashClearanceListBL.GetCardPaymentList(Convert.ToInt32(Session[Constants.S_SESSION_SCHOOL_ID]), Convert.ToInt32(Session[Constants.S_SESSION_CURRENT_ACADEMIC_YEAR_ID]),string.Empty, ClearanceListFilters.StudentNameOrRegNo,
