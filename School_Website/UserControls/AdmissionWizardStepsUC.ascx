<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdmissionWizardStepsUC.ascx.cs"
    Inherits="ASP.AdmissionWizardSteps" %>
<div>
    <table style="width: 100%; height: 100%;" id="tblAdmission" runat="server">
        <tr>
            ...
            <td align="left" class="lblAdmissionSteps" valign="middle" id="tdSelectBank" runat="server">
               <asp:Label ID="lblAdmissionPaymentTitle" runat="server" Text="Select Payment Type »"></asp:Label>&nbsp;&nbsp;
            </td>
    ...
    <table style="width: 100%; height: 100%;" id="tblStudentFee" runat="server">
        <tr>
            ...
            <td align="left" class="lblAdmissionSteps" valign="middle">
                <%--Amount Details »&nbsp;&nbsp;--%>
                <span id="spanFirstStep" runat="server">Confirm Amount »&nbsp;&nbsp;</span>
            </td>           
            <td align="left" valign="top">
                <asp:Image ID="imgFeeStep2" runat="server" />
            </td>
            <td align="left" class="lblAdmissionSteps" valign="middle" style="display:none">
                <%--Select Payment Type »&nbsp;&nbsp;--%>
                <asp:Label ID="lblFeePaymentTypeTitle" runat="server" Text="Select Payment Type »"></asp:Label>&nbsp;&nbsp;
            </td>
