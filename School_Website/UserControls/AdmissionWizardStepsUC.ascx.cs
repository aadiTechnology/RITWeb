...
namespace ASP
{
    ...
    public partial class AdmissionWizardSteps : System.Web.UI.UserControl
    {
        ...
        public void SetImagesForActiveStep()
        {
            if (!mbIsStudentFee)
            {                
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (iSchoolId == Convert.ToInt32(Utility.Constants.SchoolId.DSK) || iSchoolId == Convert.ToInt32(Utility.Constants.SchoolId.SS) || 
                iSchoolId == Constants.SchoolId.PKIS.ToInt() || iSchoolId == Constants.SchoolId.BFS.ToInt() || iSchoolId == Constants.SchoolId.SNS.ToInt() ||
                iSchoolId == Constants.SchoolId.PPS.ToInt() || iSchoolId == Constants.SchoolId.PPSH.ToInt() || iSchoolId == Constants.SchoolId.PPSN.ToInt() || iSchoolId == Constants.SchoolId.DYPV.ToInt() ||
                iSchoolId == Constants.SchoolId.DPIS.ToInt() || iSchoolId == Constants.SchoolId.VPMCPS.ToInt() ||
                (iSchoolId >= 150 && iSchoolId <= 158))
            {
                lblFeePaymentTypeTitle.Text = "Payment Tentative Charges »";
                lblAdmissionPaymentTitle.Text = "Payment Tentative Charges »";
            }

            if (iSchoolId == Constants.SchoolId.PPSN.ToInt())
                spanFirstStep.InnerText = "Gateway Selection";
