<%@ Page Title="" Language="C#" MasterPageFile="~/RITeSchool/MasterPages/PopupMasterSml.master"
    AutoEventWireup="true" CodeFile="ServiceReceiverDetailsPopup.aspx.cs" Inherits="RITeSchool_Transport_TransportDetails"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainBody" runat="Server">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="padding-right: 5px;">
                    <tr>
                        <td align="center" class="MainTitleHead" style="height: 20px">
                            <span style="font-weight: bold">Service Receiver Details</span>
                        </td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <table id="tblnamelist" align="center" width="98%">
                                        <tr align="center" style="width: 100%">
                                            <td align="center" style="width: 800">
                                                ...
                                                <asp:ObjectDataSource TypeName="BusinessLogic.ServiceReceiverDetailsBL" EnablePaging="True"
                                                    ID="objdsServiceReceiverDetails" runat="server" SelectMethod="GetAll" SortParameterName="sortExpression"
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CloseWindow(obj) {
            window.opener.location = "../Transport/ServiceReceiverDetailsPopup.aspx?" + obj;
            window.opener.focus();
            window.close();
        }
