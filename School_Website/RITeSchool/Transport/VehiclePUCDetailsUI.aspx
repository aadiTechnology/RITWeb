<%@ Page Title="" Language="C#" MasterPageFile="~/RITeSchool/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="VehiclePUCDetailsUI.aspx.cs" Inherits="VehiclePUCDetailsUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainBody" runat="Server">
            ...
            <tr>
                <td align="center" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="lstvwVehiclePUCDetails" EventName="ItemCommand" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div runat="server" id="divErr">
                                ...
                                <asp:RequiredFieldValidator ID="reqSerialNumber" runat="server" ErrorMessage="Serial Number should not be blank."
                                    ControlToValidate="txtSerialNo" Display="None"></asp:RequiredFieldValidator>
                                ...
                                <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="" ClientValidationFunction="ValidateFileSize"
                                    Display="None"></asp:CustomValidator>
                                <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="" ClientValidationFunction="ValidatePUCDate"
                                    Display="None"></asp:CustomValidator>
                        ...
                        <tr id="trFilters" runat="server" align="center" style="text-align: center; margin: 0px auto;">
                            <td width="100%" align="center" style="text-align: center; margin: 0px auto;">
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table align="center" cellpadding="1" cellspacing="2" style="text-align: center;
                                            margin: 0px auto;">
                                            ...
                                            <tr>
                                                <td valign="middle" class="ClsBorderlight">
                                                    <span class="ClsLabel">Serial Number :</span>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtSerialNo" runat="server" MaxLength="20" CssClass="LrgTxtBox"></asp:TextBox>
                                                    <span class="ClsMdtStar">*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="middle" class="ClsBorderlight">
                                                    <span class="ClsLabel">Test Date :</span>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtTestDate" CssClass="SmlTxtBox" runat="server" onchange="SetExpiryDate(this)" />
                                                    <rjs:PopCalendar ID="calTestDate" runat="server" Control="txtTestDate" Format="dd MMM yyyy"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtExpiryDate" CssClass="SmlTxtBox" runat="server" />
                                                    <rjs:PopCalendar ID="PopCalendar1" runat="server" Control="txtExpiryDate" Format="dd MMM yyyy" From-Today="true"
                                                        Culture="en" ShowWeekend="True" ShowErrorMessage="false" InvalidDateMessage="Expiry date should not be blank."
                                                        AutoPostBack="False" />
                                                    <span class="ClsMdtStar">* </span>                                                    
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtNote" runat="server" MaxLength="500" CssClass="LrgTxtBox" TextMode="MultiLine"
                                ...
                                <table align="center" style="text-align: center; margin: 0px auto;">
                                    <tr align="center" style="text-align: center;">
                                        <td class="ClsBorderlight" align="center" style="width: 150px;">
                                            <asp:Label ID="lblNameSearch" runat="server" CssClass="ClsLabel" Text="Vehicle No. / Serial No."></asp:Label>
                                        ...
                                        <table width="80%">
                                            ...
                                            <tr id="trItemCount" runat="server">
                                                <td align="center" style="width: 100%;">
                                                    <asp:DataPager ID="DtPgCount" runat="server" PageSize="20" PagedControlID="lstvwVehiclePUCDetails"
                                                        Visible="true">
                                                        <Fields>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:ListView ID="lstvwVehiclePUCDetails" runat="server" DataKeyNames="VehicalId,VehiclePUCId,IsFileExists,IsLocked"
                                                        OnDataBound="lstvwVehiclePUCDetails_DataBound" OnItemDataBound="lstvwVehiclePUCDetails_ItemDataBound"
                                                        OnSorting="lstvwVehiclePUCDetails_Sorting" OnItemCommand="lstvwVehiclePUCDetails_ItemCommand">
                                                        <LayoutTemplate>
                                                            <table width="100%" style="color: #333333" cellpadding="0" cellspacing="1" class="GridBorder">
                                                                <tr class="ClsGridHeader" id="trHeader" runat="server">
                                                                    <th align="left" class="paddingL" style="font-size: 10pt;">
                                                                     ...
                                                                     <th align="center" class="paddingL" style="width: 150px; font-size: 10pt;">
                                                                        <asp:LinkButton ID="lnkSerialNo" runat="server" CausesValidation="false" ForeColor="Black"
                                                                            CommandArgument="SerialNumber" CommandName="SortRow">Serial Number</asp:LinkButton>
                                                                    </th>
                                                                    <th align="center" class="paddingL" style="width: 100px; font-size: 10pt;">
                                                                        <asp:LinkButton ID="lnkTestDate" runat="server" CausesValidation="false" ForeColor="Black"
                                                                            CommandArgument="Date" CommandName="SortRow">Test Date</asp:LinkButton>
                                                                    </th>
                                                                    <th align="center" class="paddingL" style="width: 140px; font-size: 10pt;">
                                                                        <asp:LinkButton ID="lnkExpiryDate" runat="server" CausesValidation="false" ForeColor="Black"
                                                                            CommandArgument="EndDate" CommandName="SortRow">Expiry Date</asp:LinkButton>
                                                                    </th>
                                                                ...
                                                                <tr class="ClsBorderPager" id="trDataPager" runat="server">
                                                                    <td colspan="8" align="left">
                                                                        <asp:DataPager ID="DtPgDropDown" runat="server" PageSize="20" PagedControlID="lstvwVehiclePUCDetails">
                                                                            <Fields>
                                                                                <asp:TemplatePagerField>
                                                                                    <PagerTemplate>
                                                                                        <table width="100%">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr id="Tr2" runat="server" class="ClsGridRow">
                                                                ...
                                                                <td align="center">
                                                                    <asp:Label ID="lblSerialNumber" runat="server" CssClass="clsLabelC" Text='<%#Eval("SerialNumber") %>'></asp:Label>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Label ID="lblTestDate" runat="server" CssClass="clsLabelC" Text='<%#Eval("TestDate") %>'></asp:Label>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Label ID="lblExpiryDate" runat="server" CssClass="ClsLabel" Style="float: inherit"
                                                                        Text='<%#Eval("ExpiryDate") %>'></asp:Label>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Label ID="lblNotificationDays" runat="server" CssClass="ClsLabel" Style="float: inherit"
                                                                        Text='<%#Eval("NoticicationDays") %>'></asp:Label>
                                                                </td>
                                                    ...
                                                    <asp:HiddenField ID="hidPUCId" runat="server" Value="0" />    
                                                    <asp:HiddenField ID="hidDates" runat="server" Value="" />                                                
                                                    <asp:ObjectDataSource EnablePaging="true" TypeName="BusinessLogic.TransportBL.VehiclePUCDetailsBL"
    ...
    <script language="javascript" type="text/javascript">
        ...
        _clienttxtTestDate = "<%=this.txtTestDate.ClientID %>"
                    ...
                    for (k in data) {
                        ...
                        if (data[k].VehicleId == vehicleId) {
                            ...
                            if (passingDate < expDate)
                                return confirm('Expiry date of currently active record of selected vehicle is ' + dt + ' and you are adding earlier Test Date. Do you want to continue by marking this new record as Active?')
                        }
                    }
                }
            }
        ...
        function ValidatePUCDate(oSrc, args) {  
            var dt = $('[id$=txtTestDate]').val()
            if ($('[id$=hidPUCId]').val() == "0" && dt != '') {
                var dates = $('[id$=hidDates]').val()
                var data = JSON.parse(dates)
                var vehicleId = $('[id$=cmbVehical]').val()
                ...
                for (k in data) {
                    ...
                    if (data[k].VehicleId == vehicleId) {
                        ...
                        if (passingDate <= psDate) {
                            oSrc.errormessage = "Test Date should be greater than active record's Test Date of same vehicle."
                            args.IsValid = false
                            return true
                        }
                    }
        ...
        function ValidateNextDate(oSrc, args) {
            ...
            if (expiryDate <= currentDate) {
                oSrc.errormessage = "Expiry Date should be greater than Test Date of same vehicle."
                args.IsValid = false
                return true
            }
