<%@ Page Title="" Language="C#" MasterPageFile="~/RITeSchool/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ReportingConfigurationUI.aspx.cs" Inherits="ReportingConfigurationUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainBody" runat="Server">
            ...
            <table style="width: 100%;" cellpadding="0" cellspacing="1">
                ...
                <tr>
                    <td align="left" valign="top">
                        ...
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" HeaderText="Please correct following errors." ValidationGroup="Submit"
                            CssClass="ClsMdtStar" ShowMessageBox="false" ShowSummary="true" />
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="60%" align="center">
                            <tr>
                                <td align="left" class="ClsBorderlight">
                                    <asp:Label ID="lblYear" runat="server" CssClass="ClsLabel" Text="<%$ Resources:LocalizedResources, Year%>"></asp:Label>
                                ...
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="reqcmbYear" runat="server" Display="None" ControlToValidate="cmbYear"
                                        CssClass="ClsMdtStar" InitialValue="0" ErrorMessage= "<%$ Resources:LocalizedResources, valRequiredYear%>"></asp:RequiredFieldValidator>
                                </td>
                                <td align="left" class="ClsBorderlight">
                ...
                <asp:UpdatePanel ID="upnl1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <table width="40%" align="center">
                            <tr>
                                <td align="left" class="ClsBorderlight">
                                    <asp:Label ID="lblReportingRole" runat="server" CssClass="ClsLabel" Text="<%$Resources:LocalizedResources, Reporting%>" ></asp:Label>
                                     <span class="ClsLabel colonPadding">:</span>                                     
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                <td align="left" class="ClsBorderlight">
                                    <asp:Label ID="lblReportingStaffName" runat="server" CssClass="ClsLabel" 
                                        Text="<%$Resources:LocalizedResources, Reporting%>" ></asp:Label>
                                     <span class="ClsLabel colonPadding">:</span>                                     
                                </td>
                                <td align="left">
                            ...
                            <tr style="display:none">
                                <td align="left" class="ClsBorderlight">
                                    <asp:Label ID="lblIsSupervisor" runat="server" CssClass="ClsLabel" Text="<%$Resources:LocalizedResources, IsSupervisor%>" ></asp:Label>
                                     <span class="ClsLabel colonPadding">:</span>                  
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtApprovalSortOrder" runat="server" CssClass="SmlTxtBox"
                                    MaxLength="2" Style="text-align: right; padding-right: 5px" onblur="extractNumber(this,2,false);" ondrop="event.returnValue=false"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button CssClass="ClsBtn" ID="btnCancel" CausesValidation="false" runat="server"
                                       Text= "<%$ Resources:LocalizedResources, Cancel%>" BorderWidth="1px" OnClick="btnCancel_Click"></asp:Button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:HiddenField ID="hidAlertProgressReportUser" runat="server" />
                                    <asp:HiddenField ID="hidAlertAllProgressReportUser" runat="server" />
                            ...
                            <tr>
                                <td align="center" valign="top" runat="server" id="tdDetails">
                                    <asp:ListView ID="lstvwConfiguration" runat="server" ItemPlaceholderID="trItemPlaceholder"
                                        ClientIDMode="Inherit" OnItemCommand="lstvwConfiguration_ItemCommand" 
                                        DataKeyNames="Id,IsSubmitted,ReportingUserId" 
                                        ...
                                        <LayoutTemplate>
                                            <table id="tblDetails" style="width: 900px; color: #333333" class="GridBorder" cellpadding="0"
                                                ...
                                                <tr id="trGroupHeader" runat="server" class="ClsGridHeader">
                                                    ...
                                                    <th align="center" style="width: 10%;white-space:nowrap" class="Clspadding" id="thEdit" runat="server">
                                                        <asp:Label ID="lblEdit" runat="server" Text="<%$ Resources:LocalizedResources, Edit%>"> </asp:Label>
                                                    </th>
                                                    <th align="center" style="width: 12%;white-space:nowrap" class="Clspadding" id="thDelete" runat="server">
                                            ...
                                            <table align="center" width="900px">
                                                <tr>                                                 
                                                     <td align="center" colspan ="3" >
                                                           <asp:Label ID="lblNoRecordFound" width="900px" runat ="server" Text="<%$ Resources:LocalizedResources, NoRecordFound %>" CssClass="LblNoRecord"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                        <ItemTemplate>
                                            <tr class='<%# Container.DisplayIndex %2 == 0 ? "ClsGridRow" : "ClsGridAltRow" %>'>
                                                ...
                                                <td align="right" style="padding-right:5px">
                                                    <%--<img id="imgIsSupervisor" runat="server" src="../images/IconGrid_AssignTrue.gif"
                                                        alt="Is Supervisor" visible='<%#Eval("IsSupervisor")%>' />--%>
                                                ...
                                                <td align="center" style="width: 10%;" class="Clspadding" id="tdEdit" runat="server">
                                                    <asp:ImageButton runat="server" ID="imgEdit" CommandName="UpdateCommand"
                                                        CommandArgument='<%#Eval("Id")%>' CausesValidation="false" ImageUrl="~/RITeSchool/images/IconGrid_Edit.gif"
                                                        AlternateText="<%$ Resources:LocalizedResources, Edit%>" ToolTip="<%$ Resources:LocalizedResources, Edit%>"></asp:ImageButton>
                                                </td>
                                                <td align="center" style="width: 12%;" class="Clspadding" id="tdDelete" runat="server">
                                                    <asp:ImageButton runat="server" ID="imgDelete" CommandName="RemoveCommand" AlternateText="<%$ Resources:LocalizedResources, Delete%>" ToolTip="<%$ Resources:LocalizedResources, Delete%>"
                                                        CommandArgument='<%#Eval("Id")%>' CausesValidation="false" ImageUrl="~/RITeSchool/images/IconGrid_Delete.gif"
                                                        OnClientClick="if(!ConfirmDelete()) return false;"></asp:ImageButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:ListView>
        ...
        <tr>
            <td align="center">
                <asp:UpdatePanel ID="upnlButton" runat="server">
                    <ContentTemplate>
                        <asp:Button CssClass="ClsBtn" ID="btnBack" runat="server" Text="<%$ Resources:LocalizedResources, Back%>" BorderWidth="1px"
                            CausesValidation="false"></asp:Button>
                        <asp:Button CssClass="ClsBtn" ID="btnSubmit" runat="server" ValidationGroup="Submit"
                            Enabled="false" Text="<%$ Resources:LocalizedResources, Submit%>" BorderWidth="1px" OnClick="btnSubmit_Click">
                        </asp:Button>
                        ...
                        <asp:Button CssClass="ClsBtn" ID="btnDeleteAll" CausesValidation="false" runat="server"
                            ...
                            OnClick="btnDeleteAll_Click" OnClientClick="if(!ConfirmDeleteAll()) return false;"></asp:Button>   
                        ...
                        <asp:CustomValidator ID="CustomValidator3" runat="server" ClientValidationFunction="ValidateFinalApprover" ValidationGroup="Submit"
                                     CssClass="LblErrorMsg" Display="None"></asp:CustomValidator>
                    </ContentTemplate>
                    <Triggers>
        ...
        <tr>
                <td>
                    <table  width="90%" align="center">
                        <tr>
                            <td align="left" class="ClsBorderlight " style="width: 3%; background-color: #ffffc4;white-space:nowrap;">
                                <%--<span id="spnNote" class="LblNrmlB" style="font-weight: bold">Note:</span>--%>
                                <asp:Label ID="lblNote" runat="server" Text="<%$ Resources:LocalizedResources, Note%>" CssClass="LblNrmlB" style="font-weight: bold;white-space:nowrap;"/>
                            ...
                            <td align="left" class="ClsBorderlight" style="padding-left: 5px; white-space:nowrap;">
                                <asp:Label ID="lblVerifyNote1" runat="server" BorderWidth="0px" CssClass="LblSmlV"
                                    Text="<%$ Resources:LocalizedResources, ReportingConfigurationNote%>"></asp:Label>
                            </td>
                        </tr>                        
                    </table>
                </td>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ConfirmDelete() {
            var bResult = true
            if (!window.confirm($get("<%=hidAlertProgressReportUser.ClientID%>").value)) {
                bResult = false
            }
            return bResult
        }
        ...
        function ConfirmDeleteAll() {
            var bResult = true
            if (!window.confirm($get("<%=hidAlertAllProgressReportUser.ClientID%>").value)) {
                bResult = false
            }
            return bResult
        }
        ...
        function ValidateFinalApprover(oSrc, args) {
            ...
            function OpenPopup() {
                ...
                window.open('CopyReportingConfigPopup.aspx?' + queryString, '_new', 'scrollbars=yes,resizable=no,top=0,left=0,width=500,height=500').focus(); 
            }
