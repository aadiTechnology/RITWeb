<%@ Page Title="" Language="C#" MasterPageFile="~/RITeSchool/MasterPages/MasterPage.master" 
    AutoEventWireup="true" CodeFile="CashClearanceListUI.aspx.cs" Inherits="CashClearanceListUI" %>
                                        ...
                                        <table align="center" cellpadding="1" cellspacing="2" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" valign="top" class="ClsBorderlight">
                                                    <span class="ClsLabel">Include cash payments which are cleared.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td align="right" valign="top" colspan="3">
                                                                <asp:GridView ID="grdvwClearedCash" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                    ...
                                                                    DataKeyNames="Receipt_Number" OnPageIndexChanging="grdvwClearedCash_PageIndexChanging">
