<%@ Page Title="" Language="C#" MasterPageFile="~/RITeSchool/MasterPages/PopupMasterSml.master"
    AutoEventWireup="true" CodeFile="CopyLeaveApprovalConfigurationPopup.aspx.cs"
    Inherits="CopyLeaveApprovalConfigurationPopup" %>
        ...
        <tr>
            <td align="center">
                <table width="80%">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnCopy" runat="server" Text="Copy and Submit" CssClass="ClsBtn" OnClick="btnCopy_Click"
                                disable-page="true" />
