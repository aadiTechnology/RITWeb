<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxDeductionConfigPopup.aspx.cs"
    MasterPageFile="../MasterPages/PopupMasterSml.master" Inherits="TaxDeductionConfigPopup" %>
                        ...
                        <asp:Panel ID="Panel2" runat="server" Width="100%">
                            <table width="60%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td class="ClsMdtStar" align="left" style="white-space: nowrap">
                                        <asp:TextBox ID="txtFatherName" runat="server" MaxLength="50" TabIndex="10" Width="250px" onblur="formatName(this)"
                                ...
                                <tr>                                    
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="cmbDesignations" runat="server" CssClass="ExLrgCombo"
                                            TabIndex="11">
                                        </asp:DropDownList>
