...
public partial class OnlineAdmission : BaseMasterPage
{
	...
	private void UpdateLogo()
	{
        ...
        {
            schoolLogo.Attributes["style"] = "height: 100px; background: url('../images/schoollogoSNS.jpg') no-repeat scroll center center #fff;";
            schoolLogo.Controls.Clear();
        }
        ...
        else if (ConfigurationManager.AppSettings["SchoolID"].ToInt() == Constants.SchoolId.VPMCPS.ToInt())
        {
            schoolLogo.Attributes["style"] = "height: 100px; background: url('Images/Logos/School_LogoSML.bmp') no-repeat scroll center center #fff;";
            schoolLogo.Controls.Clear();
        }
        ...
        if (ConfigurationManager.AppSettings["SchoolID"].ToInt() == Constants.SchoolId.PPS.ToInt() || ConfigurationManager.AppSettings["SchoolID"].ToInt() == Constants.SchoolId.PPSH.ToInt() || ConfigurationManager.AppSettings["SchoolID"].ToInt() == Constants.SchoolId.PPSN.ToInt())
        {
            schoolLogo.Attributes["style"] = "height: 150px; background: url('../../images/PPSLogo.bmp?version=1.0') no-repeat scroll center center #fff;";
            schoolLogo.Controls.Clear();
        }
    }
