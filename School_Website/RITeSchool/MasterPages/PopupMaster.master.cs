...
public partial class PopupMaster : BaseMasterPage
{
	...
	protected override void OnLoad(EventArgs e)
	{
		try
		{
			...
			//myHtmlLink.Href = "~/RITeSchool/Scripts/Styles.css";
			//myHtmlLink.Attributes.Add("rel", "stylesheet");
			//myHtmlLink.Attributes.Add("type", "text/css");
			//Page.Header.Controls.Add(link);   

			//myHtmlLink.Href = "~/RITeSchool/Scripts/Styles1.css";
			//myHtmlLink.Attributes.Add("rel", "stylesheet");
			//myHtmlLink.Attributes.Add("type", "text/css");
			//Page.Header.Controls.Add(link);   

			//myHtmlLink.Href = "~/RITeSchool/Scripts/Styles2.css";
			//myHtmlLink.Attributes.Add("rel", "stylesheet");
			//myHtmlLink.Attributes.Add("type", "text/css");
			//Page.Header.Controls.Add(link);   

			//myHtmlLink.Href = "~/RITeSchool/Scripts/Styles3.css";
			//myHtmlLink.Attributes.Add("rel", "stylesheet");
			//myHtmlLink.Attributes.Add("type", "text/css");
			//Page.Header.Controls.Add(link);   

			//myHtmlLink.Href = "~/RITeSchool/Scripts/ppsStyles.css";
			//myHtmlLink.Attributes.Add("rel", "stylesheet");
			//myHtmlLink.Attributes.Add("type", "text/css");
			//Page.Header.Controls.Add(link);   
	...
	public string GetPageRequest()
	{
        ...
        if (!sPageRequest.ToUpper().Equals("ERROR") && Convert.ToBoolean(Session[Utility.Constants.S_SESSION_IS_LOGIN_FROM_MOBILE]) == false)
		{
			if (sPageRequest.ToUpper().Equals("PAYMENTCONFIRMATIONUI"))
			{
				tdOuterImage.Visible = true;
				tdCommonImage.Visible = false;
			}
			else
			{
				tdOuterImage.Visible = false;
				tdCommonImage.Visible = true;
			}
		}
