<%@ Page Title="" Language="C#" MasterPageFile="../MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="StandardI.aspx.cs" Inherits="RITeSchool_Common_StandardI" %>
             ...
             <table width="45%" align="center">
                    <tr>
                         <td align="center" style="font-weight: bold" width="100%" class="TotalCount ClsBorderBlue">
                            <asp:Label ID="Label2" runat="server" CssClass="ClsConfigText" Text="Syllabus for Standard-VI"></asp:Label>
                        </td>
                    </tr>
                    <tr width="45%">
