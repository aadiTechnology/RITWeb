<%@ Page Title="" Language="C#" MasterPageFile="../MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="SyllabusSrKg.aspx.cs" Inherits="RITeSchool_Syllabus_SyllabusSrKg" %>
                ...
                <table width="45%" align="center">
                    <tr>
                        <td align="center" style="font-weight: bold" width="100%" class="TotalCount ClsBorderBlue">
                            <asp:Label ID="Label2" runat="server" CssClass="ClsConfigText" Text="Activities for Senior KG"></asp:Label>
                        </td>
                    </tr>
                    <tr width="45%">
                        <td align="center" style="font-size: large; " width="20%" class="WeekDCell ClsBorderlight">
                            <asp:LinkButton ID="lnkSeniorKGJune" runat="server" CssClass="Lbl10ptB">June & July - Click Here to Download</asp:LinkButton>
                        </td>
                    </tr>
                  <tr width="45%">
                        <td align="center" style="font-size: large;background-color:#ffcccc" width="20%" class="WeekDCell ClsBorderlight">
                            <asp:LinkButton ID="lnkSeniorKGAugSept" runat="server" CssClass="Lbl10ptB">August & September - Click Here to Download</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>
