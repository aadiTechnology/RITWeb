<%@ Page Title="" Language="C#" MasterPageFile="../MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="StandardVI.aspx.cs" Inherits="RITeSchool_Common_StandardVI" %>
                    ...
                    <table>
                        <tr>
                            <td align="center" style="font-weight: bold">
                                <asp:Label ID="lblHeader" runat="server" CssClass="ClsConfigText" Text="Syllabus for Standard VI"></asp:Label>
                            </td>
                        </tr>
                        <tr>
             ...
             <table width="45%" align="center">
                    <tr>
                         <td align="center" style="font-weight: bold" width="100%" class="TotalCount ClsBorderBlue">
                            <asp:Label ID="Label2" runat="server" CssClass="ClsConfigText" Text="Syllabus for Standard-VII"></asp:Label>
                        </td>
                    </tr>
                    <tr width="45%">
