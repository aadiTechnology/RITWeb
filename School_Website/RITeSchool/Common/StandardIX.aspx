<%@ Page Language="C#" MasterPageFile="../MasterPages/MasterPage.master" AutoEventWireup="true"
    CodeFile="StandardIX.aspx.cs" Inherits="RITeSchool_Common_StandardIX" %>
                ...
                <table width="45%" align="center">
                    <tr>
                        <td align="center" style="font-weight: bold" width="100%" class="TotalCount ClsBorderBlue">
                            <asp:Label ID="Label2" runat="server" CssClass="ClsConfigText" Text="Syllabus for Standard-IX"></asp:Label>
                        </td>
                    </tr>
                    <tr width="45%">
                        <td align="center" style="font-size: large; background-color: #ffcccc" width="20%"
                            class="WeekDCell ClsBorderlight">
                            <asp:LinkButton ID="lnkWorksheetI" runat="server" CssClass="Lbl10ptB">Worksheet-I and Unit Test-I(2011-2012) - Click Here to Download</asp:LinkButton>
                        </td>
                    </tr>
                    <tr width="45%">
                        <td align="center" style="font-size: large; background-color: #ffcccc" width="20%"
