<%@ Page Title="" Language="C#" MasterPageFile="../MasterPages/MasterPage.master"
 AutoEventWireup="true" CodeFile="SyllabusPrimary.aspx.cs" Inherits="RITeSchool_Common_SyllabusPrimary" %>
                    ...
                    <table>
                        <tr>
                            <td align="center" style="font-weight: bold">
                                <asp:Label ID="lblHeader" runat="server" CssClass="ClsConfigText" Text="Syllabus for Standard II"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        <td align="center" style="font-size: large">
                        <asp:LinkButton ID="lnkStdard" runat="server" CssClass="Lbl10ptB">Term 2</asp:LinkButton>
                        </td>
                         </tr>
                    </table>
                </td>
             ...
             <table width="45%" align="center">
                    <tr>
                         <td align="center" style="font-weight: bold" width="100%" class="TotalCount ClsBorderBlue">
                            <asp:Label ID="Label2" runat="server" CssClass="ClsConfigText" Text="Activities for Standard-II"></asp:Label>
                        </td>
                    </tr>
                    <tr width="45%">
                        <td align="center" style="font-size: large; background-color: #ffcccc" width="20%"
                            class="WeekDCell ClsBorderlight">
                            <asp:LinkButton ID="lnkStdTerm" runat="server" CssClass="Lbl10ptB">Term 2 - Click Here to Download</asp:LinkButton>
                        </td>
                    </tr>
                    </table>
               </td>
